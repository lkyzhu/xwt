...
//
// NOTE: While the `aud` claim is OPTIONAL in a xwt, the handling of it is
...
//
// NOTE: While the `iss` claim is OPTIONAL in a xwt, the handling of it is
// application-specific. Since this validation API is helping developers in
// writing secure application, we decided to REQUIRE the existence of the claim,
...
//
// NOTE: While the `sub` claim is OPTIONAL in a xwt, the handling of it is
// application-specific. Since this validation API is helping developers in
// writing secure application, we decided to REQUIRE the existence of the claim,
...
// WithPaddingAllowed will enable the codec used for decoding xwts to allow
...
// xwt are producing non-standard tokens, and thus require support for decoding.
...
// WithStrictDecoding will switch the codec used for decoding xwts into strict

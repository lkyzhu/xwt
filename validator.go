...
func (v *Validator) Validate(claims Claims) error {
	...
	return internal.JoinErrors(errs...)
}
...
func (v *Validator) verifyAudience(claims Claims, cmp string, required bool) error {
	...
	return errorIfFalse(result, internal.ErrTokenInvalidAudience)
}
...
func (v *Validator) verifyIssuer(claims Claims, cmp string, required bool) error {
	...
	return errorIfFalse(iss == cmp, internal.ErrTokenInvalidIssuer)
}
...
func (v *Validator) verifySubject(claims Claims, cmp string, required bool) error {
	...
	return errorIfFalse(sub == cmp, internal.ErrTokenInvalidSubject)
}
...
func errorIfRequired(required bool, claim string) error {
	if required {
		return internal.NewError(fmt.Sprintf("%s claim is required", claim), internal.ErrTokenRequiredClaimMissing)
	} else {
		return nil
	}
}
